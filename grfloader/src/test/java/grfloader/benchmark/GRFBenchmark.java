package turoran.robrowser.grfloader.benchmark;
...
public class GRFBenchmark {

    private static File getResourceFile(String name) {
        URL url = GRFBenchmark.class.getClassLoader().getResource(name);
        if (url == null) {
    ...
    public void runBenchmarks() throws Exception {
        ...
        java.io.File resultsFile = new java.io.File("src/test/java/grfloader/benchmark/benchmark-results.json");
